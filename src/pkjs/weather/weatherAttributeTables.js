...
exports.conditions = exports.getWindDirectionSymbol = exports.messages = void 0;
var messages = {
  weather_ok: 0,
  weather_disabled: 1,
  location_error: 2,
...
var getWindDirectionSymbol = function getWindDirectionSymbol(direction) {
  var directions = ['o', 'p', 'q', 'r', 'k', 'l', 'm', 'n'];
  var sector = Math.round(direction / 45);
  return sector !== 8 ? directions[sector] : directions[0];
};

exports.getWindDirectionSymbol = getWindDirectionSymbol;
var conditions = {
  200: {
